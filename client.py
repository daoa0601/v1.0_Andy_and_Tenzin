        ...
        if (not os.path.exists(filepath)) or (not os.path.isfile(filepath)):
            ...
            try:
                ...
                if cmd_res_struct['result_1'] == cmdp.res_reject:
                    ...
                    try:
                        upload_method = SiFT_UPL(mtp)
                        upload_method.handle_upload_client(cmd_req_struct['param_1'])
        ...
        try:
            ...
            if cmd_res_struct['result_1'] == cmdp.res_reject:
                ...
                if yn in ('y', 'yes', 'Y', 'YES', 'Yes'):
                    ...
                    try:    
                        dn_load = SiFT_DNL(mtp)
                        dn_load.handle_download_client(cmd_req_struct['param_1'])
                    ...
                    try:
                        dn_load = SiFT_DNL(mtp)
                        dn_load.cancel_download_client()
                    except SiFT_DNL_Error as e:
                        raise SiFT_DNL_Error(e.err_msg)
